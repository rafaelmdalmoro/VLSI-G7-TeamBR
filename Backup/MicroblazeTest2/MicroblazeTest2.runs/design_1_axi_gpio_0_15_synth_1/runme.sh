...
HD_PWD='C:/Users/vikto/Experiments/MicroblazeTest2/MicroblazeTest2.runs/design_1_axi_gpio_0_15_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_0_15.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_0_15.tcl
