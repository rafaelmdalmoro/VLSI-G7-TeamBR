...
HD_PWD='C:/Users/vikto/Experiments/Microblaze_Test3/Microblaze_Test3.runs/design_1_axi_gpio_8_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_8_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_8_2.tcl
